...
class ReplacementModel(TransformerBridge):
    ...
    def from_config(
        ...
        **kwargs,
        ...
        """Create a ReplacementModel from a given TransformerBridge.cfg and dict of transcoders

        Args:
            config (TransformerBridge.cfg): the config of the TransformerBridge that this
        ...
        if model_name == "custom":
            raise ValueError("TransformerBridge does not support custom model initialization.")
    ...
    def from_pretrained_and_transcoders(
        ...
        **kwargs,
        ...
        """Create a ReplacementModel from the name of TransformerBridge and dict of transcoders

        Args:
            model_name (str): the name of the pretrained TransformerBridge that this
                ReplacmentModel will inherit from
            transcoders (Dict[int, nn.Module]): A dict that maps from layer -> Transcoder
            feature_input_hook (str, optional): The hookpoint of the model that transcoders
